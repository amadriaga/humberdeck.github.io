...
```
humberdeck_v2.0_outlines_master.svg
```
✅ No font dependencies, works everywhere

**Dark Backgrounds**
```
humberdeck_v2.0_white_outlines_master.svg
```
✅ No font dependencies, works everywhere
...
```
humberdeck_v1.0_helvetica_neue_text_master.svg
```
⚠️ Requires Helvetica Neue font

**White Version (Editable Text)**
```
humberdeck_v1.0_white_master.svg
```
⚠️ Requires Helvetica Neue font
...
**Favicon**
```
humberdeck_favicon_v1.0_master.svg
```
...
**Profile Picture**
```
humberdeck_icon_v1.0_master.svg (export to PNG 400x400)
```

**Cover/Banner**
```
humberdeck_v1.0_helvetica_neue_text_master.svg (export to PNG 1200x630)
```

### For Print
**Business Cards, Letterhead**
```
humberdeck_v1.0_helvetica_neue_text_master.svg (high-res PNG or SVG)
```

**Icon Only**
```
humberdeck_icon_v1.0_master.svg
```
...
```powershell
# Standard web logo
inkscape humberdeck_v1.0_helvetica_neue_text_master.svg -w 500 -h 140 -o logo.png

# Square icon for social media
inkscape humberdeck_icon_v1.0_master.svg -w 400 -h 400 -o icon-400.png

# Favicon
inkscape humberdeck_favicon_v1.0_master.svg -w 32 -h 32 -o favicon.png
```
...
<picture>
  <source media="(prefers-color-scheme: dark)" 
          srcset="logo/humberdeck_v1.0_white_master.svg">
  <img src="logo/humberdeck_v1.0_helvetica_neue_text_master.svg" 
       alt="Humberdeck" height="70">
</picture>
```
