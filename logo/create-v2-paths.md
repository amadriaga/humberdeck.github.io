...
2. **Convert each file**:
   ...
   inkscape "humberdeck_v1.0_helvetica_neue_text_master.svg"
   
   # In Inkscape:
   # 1. Select all text (Ctrl+A or click text)
   # 2. Go to: Path > Object to Path (Ctrl+Shift+C)
   # 3. Save As: humberdeck_v2.0_outlines_master.svg
   ```

3. **Files to convert**:
   - `humberdeck_v1.0_helvetica_neue_text_master.svg` → `humberdeck_v2.0_outlines_master.svg`
   - `humberdeck_v1.0_white_master.svg` → `humberdeck_v2.0_white_outlines_master.svg`
...
- ✅ `humberdeck_v2.0_outlines_master.svg` (main logo, paths)
- ✅ `humberdeck_v2.0_white_outlines_master.svg` (white version, paths)
