...
Logo and branding resources for humberdeck.com.
...
- **humberdeck_v2.0_outlines_master.svg** - Main logo, text as paths (7.14 KB) ✓
- **humberdeck_v2.0_white_outlines_master.svg** - White version for dark backgrounds (6.66 KB) ✓
...
- **humberdeck_v1.0_helvetica_neue_text_master.svg** - Primary logo with editable text (550x140)
- **humberdeck_v1.0_white_master.svg** - White version with editable text
- **humberdeck_icon_v1.0_master.svg** - Square icon only (200x200)
- **humberdeck_favicon_v1.0_master.svg** - Optimized favicon (32x32)
...
- **logo-horizontal.svg** - Logo with "Humberdeck" text (600x200)
...
<link rel="icon" type="image/svg+xml" href="/logo/humberdeck_favicon_v1.0_master.svg">
...
<img src="/logo/humberdeck_v1.0_helvetica_neue_text_master.svg" alt="Humberdeck" height="70">

<!-- White version (dark backgrounds) -->
<img src="/logo/humberdeck_v1.0_white_master.svg" alt="Humberdeck" height="70">

<!-- Icon only -->
<img src="/logo/humberdeck_icon_v1.0_master.svg" alt="Humberdeck" width="60" height="60">
```
...
inkscape humberdeck_v1.0_helvetica_neue_text_master.svg -w 500 -h 140 -o logo-500x140.png

# From icon file
inkscape humberdeck_icon_v1.0_master.svg -w 192 -h 192 -o icon-192x192.png
inkscape humberdeck_icon_v1.0_master.svg -w 512 -h 512 -o icon-512x512.png

# Favicon from favicon master
inkscape humberdeck_favicon_v1.0_master.svg -w 32 -h 32 -o favicon-32x32.png
```
...
1. **Copy logo files** to `humberdeck/logo/` directory
2. **Update HTML** with favicon links (see above)
3. **Reference in HTML**:
   ```html
   <!-- In header/navbar -->
   <img src="/logo/humberdeck_v1.0_helvetica_neue_text_master.svg" 
        alt="Humberdeck" 
        height="70">
   ```
...
4. **For CSS backgrounds**:
   ```css
   .logo {
     background-image: url('/logo/humberdeck_icon_v1.0_master.svg');
     width: 60px;
     height: 60px;
   }
   ```
...
Email: contact@humberdeck.com

---

© 2026 Humberdeck. All rights reserved.
