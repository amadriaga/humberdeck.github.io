...
```
✅ humberdeck_v2.0_outlines_master.svg (7.14 KB)
   - Use on light backgrounds
   - Default choice for most pages
   
✅ humberdeck_v2.0_white_outlines_master.svg (6.66 KB)
...
```html
<!-- Light background -->
<img src="./humberdeck_v2.0_outlines_master.svg" 
     alt="HumberStack Logo" 
     width="275" 
     height="70">

<!-- Dark background -->
<img src="./humberdeck_v2.0_white_outlines_master.svg" 
     alt="HumberStack Logo" 
     width="275" 
     height="70">
```
...
<div class="logo">
  <?php include 'humberdeck_v2.0_outlines_master.svg'; ?>
</div>
```
...
```css
.header-logo {
  background-image: url('humberdeck_v2.0_outlines_master.svg');
...
```jsx
import Logo from './humberdeck_v2.0_outlines_master.svg';
...
```powershell
# Copy to your humberdeck website
cd d:\dev\cloudflare-websites\humberdeck\

# Create assets directory
mkdir assets\logos -Force

# Copy v2.0 files
Copy-Item ..\logo\humberdeck_v2.0_outlines_master.svg assets\logos\
Copy-Item ..\logo\humberdeck_v2.0_white_outlines_master.svg assets\logos\
...
<img src="./assets/logos/humberdeck_v2.0_outlines_master.svg" 
     alt="HumberStack Logo" 
     width="275" 
     height="70">
```
...
```html
<link rel="preload" 
      href="./humberdeck_v2.0_outlines_master.svg" 
      as="image" 
      type="image/svg+xml">
```
...
<img src="https://cdn.humberdeck.com/logos/v2/logo.svg" 
     alt="HumberStack Logo">
```
...
**Quick Start**: Copy `humberdeck_v2.0_outlines_master.svg` to your project and reference it in `<img>` tags. Done! ✅
