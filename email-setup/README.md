# Email Setup for humberdeck.com
...
2. Go to Cloudflare Dashboard → humberdeck.com → Email Routing
3. Enable Email Routing and add your destination email
4. Create email addresses like contact@humberdeck.com

## 📧 What You Get (Free)

- ✅ Unlimited email addresses @humberdeck.com
...
The website's contact form ([../humberdeck/contact.html](../humberdeck/contact.html)) is ready to integrate with an Email Worker once deployed.

## 🆘 Support

Questions? Email: contact@humberdeck.com
