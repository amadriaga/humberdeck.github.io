# Quick Start Checklist - Email Setup for humberdeck.com

## Step-by-Step Setup (5 minutes)

### ☐ Step 1: Enable Email Routing
1. Go to https://dash.cloudflare.com
2. Click on **humberdeck.com**
...
- [ ] Create `contact@humberdeck.com`
- [ ] Create `info@humberdeck.com`
- [ ] Create `support@humberdeck.com` (if needed)

**Option B: Catch-all**
- [ ] Enable catch-all to receive *@humberdeck.com

### ☐ Step 4: Test It
1. Send an email TO your new address (e.g., contact@humberdeck.com)
2. Check your personal email - it should arrive within seconds
3. ✅ Done!

## What You Can Do Now
- ✅ Receive emails at any address @humberdeck.com
