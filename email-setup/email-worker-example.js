...
// Deploy this to send emails FROM your humberdeck.com domain
...
export default {
  async fetch(request, env) {
    ...
    try {
      const { to, subject, message, from = 'contact@humberdeck.com' } = await request.json();
...
const MAILGUN_DOMAIN = 'humberdeck.com';
...
const response = await fetch(
  `https://api.mailgun.net/v3/${MAILGUN_DOMAIN}/messages`,
  {
    ...
    body: new URLSearchParams({
      from: `Humberdeck <contact@humberdeck.com>`,
      to: to,
      subject: subject,
      html: message,
    }),
